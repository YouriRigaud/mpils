...
if @scenariofile
	scenarioparams = {"algo" => @algo, "run_obj"=>@run_obj, "overall_obj"=>@overall_obj, "cutoff_time"=>@cutoff_time, 
			...
			"execdir"=>$execdir, "outdir"=>@outdir, "paramfile"=>$param_file, "logfile"=>@log_file, "feature_file"=>nil,
			"maxEvals"=>@maxEvals, "wallclock-limit"=>@maxWallTime} # FH: added feature_file for convenient reading of SMAC scenario files
	...
	@log_file = scenarioparams["logfile"]
	...
	@maxEvals = scenarioparams["maxEvals"].to_f
...
puts $param_file
#@log_file = "#{$execdir}logfile.log" unless @log_file
#puts @log_file
